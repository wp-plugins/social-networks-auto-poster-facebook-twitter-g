...
if (!class_exists("nxs_snapClassTW")) { class nxs_snapClassTW {
  ...
  function showEdPostNTSettings($ntOpts, $post){ global $nxs_plurl; $post_id = $post->ID; $nt = 'tw'; $ntU = 'TW';
    ...
    <?php }  } ?>
                ...
                <input value="0"  type="hidden" name="tw[<?php echo $ii; ?>][rpstPostIncl]"/><input value="1" type="checkbox" name="tw[<?php echo $ii; ?>][rpstPostIncl]"  <?php if ((int)$ntOpt['rpstPostIncl'] == 1) echo "checked"; ?> /> 
                </th>
