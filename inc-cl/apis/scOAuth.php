...
define('SCOOPIT_ACCESS_TOKEN_PATH', "/oauth/access");
define('SCOOPIT_AUTHORIZE_PATH', "/oauth/authorize");
define('SCOOPIT_REQUEST_TOKEN_PATH', "/oauth/request");
...
class wpScoopITOAuth{
    ...
    function getReqToken($cbu){      
      ...
      $req['normalized_url'] = $this->baseURL.SCOOPIT_REQUEST_TOKEN_PATH; 
      ...
      $url = $this->baseURL.SCOOPIT_REQUEST_TOKEN_PATH.'?oauth_nonce='.$args['oauth_nonce'].'&oauth_timestamp='.$args['oauth_timestamp'].'&oauth_consumer_key='.$this->consumer_key.'&oauth_signature_method='.$args['oauth_signature_method'].'&oauth_version='.$args['oauth_version'].'&oauth_callback='.$cbu.'&oauth_signature='.$args['oauth_signature'];      
